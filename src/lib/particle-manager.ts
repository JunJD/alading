...
const sphereRad = 380 // 20..500
const radius_sp = 1.5 // 1..2
let framesPerRotation = 5000
let r: number = 0, g: number = 0, b: number = 0  // particle color
...
const onUserSpeaking = () => {
    ...
    framesPerRotation = 4000
    setOrange()
}
const onProcessing = () => {
    console.log("processing")
    framesPerRotation = 800
    setViolet()
}
const onAiSpeaking = () => {
...
const recycleBin: ParticleList = {
    first: null
}
const particleAlpha = 0.8
const fLen = 420
let m: number
...
let nextParticle: Particle | null
let sinAngle: number
let cosAngle: number
...
function draw(context: CanvasRenderingContext2D, displayWidth: number, displayHeight: number, projCenterX: number, projCenterY: number): void {
    ...
    while (p != null) {
        ...
        */
        ...
        if (outsideTest || p.dead) {
            ...
            context.shadowColor = rgbString() + "0.5)";
        }
